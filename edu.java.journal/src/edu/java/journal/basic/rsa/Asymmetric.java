...
public class Asymmetric {
	...
	public static void main(String arg[]) throws Exception {
		...
		//write the encrypted text to file     
	      try {
	          FileWriter myWriter = new FileWriter(System.getProperty("java.io.tmpdir") +"\\license.alm");
		...
		//read and convert encrypted text from file
	      try {
	          File myObj = new File(System.getProperty("java.io.tmpdir") +"\\license.alm");
	          Scanner myReader = new Scanner(myObj);
	          while (myReader.hasNextLine()) {
	            String data = myReader.nextLine();
	            System.out.println(data);
	            
	        	String decryptedText2 = do_RSADecryption(cipherText, keypair.getPublic());
