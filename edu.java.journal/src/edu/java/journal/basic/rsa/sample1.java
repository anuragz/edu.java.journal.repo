...
public class sample1 {
	...
	/*
	 * Larger data gives: javax.crypto.IllegalBlockSizeException: Data must not
	...
	static public void main(String[] args) throws Exception {
		...
		if (command.equals("genkey")) {
			doGenkey(params);
		} else if (command.equals("tnyenc")) {
			doEncrypt(params);
		} else if (command.equals("tnydec")) {
			doDecrypt(params);
		} else if (command.equals("enc")) {
			doEncryptRSAWithAES(params);
		} else if (command.equals("dec")) {
			doDecryptRSAWithAES(params);
		} else {
