...
public class ArrayListDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(
					"Removing the last element using iterator remove will cause exception if iterator has finished");
		}
		...
		System.out.println("\nPrint element after sorting by name");
		for (Employee e : emps) {
			System.out.println(e.getId() + " - " + e.getName() + " - " + e.getSalary());
		}

		// sort by employee name reverse order
		Collections.sort(emps, (new EmployeeNameComparator()).reversed());
		System.out.println("\nPrint element after sorting by name in reverse order");
		for (Employee e : emps) {
			System.out.println(e.getId() + " - " + e.getName() + " - " + e.getSalary());
		}
	}
